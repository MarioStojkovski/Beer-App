  ...
  try {
    ...
    switch (sort) {
      ...
      case `${dropdownSortByMenu[5].value}`:
        sortedBeers = data.sort(
          (a, b) =>
            a.first_brewed.split("/").reverse().join("") -
            b.first_brewed.split("/").reverse().join("")
        );
        break;
    }
...
function showBeers(beers) {
  ...
  beers.forEach((beer) => {
    ...
    card.innerHTML += ` <img src="${beer.image_url}" class="card-img-top d-block mx-auto px-3 my-2" alt="beer" height="400px">
              <div class="card-body">
  ...
  detailsCard.innerHTML += `
        <div class="row g-0">
            <div class="col-md-4">
                <img src="${
                  beer.image_url
                }" class="img rounded-start d-block mx-auto" alt="beer" height="500px">
            </div>
...
//How much beers to be shown per page.
...
//Showing more details about beer.
